 ...
 */
package eci.escuelaing.arepbus;
...
public class HelloWorldConsumer implements Runnable, ExceptionListener {
        public void run() {
            try {
                ...
                ActiveMQConnectionFactory connectionFactory = new ActiveMQConnectionFactory("tcp://ec2-54-86-104-171.compute-1.amazonaws.com:61616?jms.useAsyncSend=true");
